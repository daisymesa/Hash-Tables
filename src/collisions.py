...
def how_many_before_collision(buckets, loops=1):
    # Roll random hash indexes into buckets and print how many rolls before a hash how_many_before_collision
...
def longest_linked_list_chain(keys, buckets, loops=10):
    '''
    Rolls key number of random keys into buckets
    ...
    for i in range(loops):
        ...
        print(
            f"Longest Linked List Chain for {keys} keys in {buckets} buckets (Load Factor: {keys/buckets:2f}: {largest_number})")
